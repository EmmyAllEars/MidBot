...
module.exports = (robot) ->
  ...
  robot.respond /help|halp/i, (msg) ->
    ...
    helptext = [
        "Looks like you need a hand! This is why I'm here. Also because I'm spiritually bonded to--but hey whatever. My name is Mid, and you gotta use it to get results.",
